...
Although the effect of \textit{pre-scheduling} will be alleviated by the simple DAG computing, some shuffle-heavy jobs can still be optimized by SCache shuffle data management.
