...
% \title{Efficient Shuffle Management with the FRQ Model for Data Intensive Applications}
%
%
...
% \author{Rui Ren, Chunghsuan Wu, Zhouwang Fu, Tao Song, Yanqiang Liu, Zhengwei Qi,~\IEEEmembership{Member,~IEEE,} Haibing Guan,~\IEEEmembership{Member,~IEEE}
...
\input{./tex/abstract}
\begin{IEEEkeywords}
Distributed DAG frameworks, Shuffle, Optimization, Performance model
\end{IEEEkeywords}
...
% simpler here.)
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/Rui_Ren}}]{Rui Ren}
...
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/Chunghsuan_Wu}}]{Chunghsuan Wu}
...
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/Tao_Song}}]{Tao Song}
...
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/YanQiang_Liu.png}}]{Yanqiang Liu}
% % \begin{IEEEbiography}{Yanqiang Liu}
% Yanqiang Liu is currently a Ph.D. student in computer science of Shanghai Jiao Tong University. He received his Bachelor degree in software engineering from Shanghai Jiao Tong University. 
% \end{IEEEbiography}

% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/Zhengwei_Qi}}]{Zhengwei Qi}
...
% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/Haibing_Guan}}]{Haibing Guan}
