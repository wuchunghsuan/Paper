...
{\color{blue}
BASS\cite{qin2017bandwidth} combines SDN (Software-defined networking) with Hadoop and provides a bandwidth-aware task shceduling to optimize shuffle phases.
