...
{\color{blue}
However, such early-start has several deficiencise.
...
% We have also designed a performance model called FRQ model to analyze the shuffle optimization of SCache and predict the execution time of each phase of a computing job. 
