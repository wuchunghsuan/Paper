...
\IEEEcompsocthanksitem R. Ren ...\protect
E-mail: renrui@sjtu.edu.cn
...
\begin{IEEEbiography}{Rui Ren}

\end{IEEEbiography}

% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/ChugnHsuan_Wu}}]{Chunghsuan Wu}
\begin{IEEEbiography}{Chunghsuan Wu}

\end{IEEEbiography}

% \begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./fig/author/ZhouWang_Fu}}]{Zhouwang Fu}
\begin{IEEEbiography}{Zhouwang Fu}
