...
{\color{blue}
In order to analyze above-mentioned resources scheduling strategies, we propose a performance model called \textit{Framework Resources Quantification} (FRQ) model. The FRQ model quantifies computing and I/O resources and displays resources scheduling strategy of DAG framework in the time dimension. We use the FRQ model to assist in analyze the deficiencies of resources scheduling and optimize it. 
